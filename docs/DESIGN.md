...
> Design notes for **creator-premiere-chat** — a runnable typescript example that A typed Node service that opens realtime viewer chat after a media asset reaches creator delivery.
...
- **Feature code** — the actual task: creator premiere chat.
